...
// It should show simply have an empty list where cupcakes should appear and a form where new
...
//         handles form submission to both let the API know about the new cupcake
//  and updates the list on the page to show it
